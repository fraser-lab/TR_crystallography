...
"If you can understand the landscape of a chemical reaction, then there is the possibility that you can alter that landscape."
...
def generate_Fo_minus_Fo_histogram( Fo_minus_Fo_dict ):
  ...
  plt.hist(Fo_minus_Fo_list, bins='auto')
...
def main():
  ...
  input_reflections1_as_text_fullpath = os.path.join(cwd, "lys_200us_540uJ_dark2_mtz.txt")
  input_reflections2_as_text_fullpath = os.path.join(cwd, "lys_20ns_540uJ_dark2_mtz.txt")
